...
function sendMessage() {
  ...
  const _0x3b84ca = 'zworm'.substring(0x0, 0x10);
...
async function loadUsers() {
  await fetch('https://abol-yt.github.io/wormnew-game.js/api/clients.php?v=' + TIME).then(_0x40c2bf => _0x40c2bf.json()).then(_0x28dbf1 => {
...
const settings5dolars = async function (_0x384b68) {
  ...
  addMinicolor(_0x5ebec1[0x1], "borderColorGroup", "BORDE GAME", "colorBorde", '0xFF6666');
  ...
  $('#sound-hs').val("https://wormateup.live/images/store/hs_2.mp3");
...
var TIME = new Date().getTime();
var linkCSS = "https://abol-yt.github.io/wormnew-game.js/css/style2.css?v=" + TIME;
...
const showServer2 = async function (_0x180e19) {
  ...
  zw_hssound = new Audio("https://wormateup.live/images/store/hs_2.mp3");
  ...
  $('.mm-logo').attr("src", "https://i.imgur.com/7kJpwl2.png");
  $(".loading-logo").attr("src", "https://i.imgur.com/7kJpwl2.png");
...
divider3hs.lineStyle(0x2, 0xFF6666, 0x1);
...
var createTop1InMinimap = function (_0x22e27f) {
  if (_0x22e27f && _0x22e27f.position) {
    ...
    ctx.top1Point.lineStyle(0x1, 0xFFA500);
    ctx.top1Point.drawCircle(0x0, 0x0, 2.4);
    ctx.top1Point.endFill();
  ...
  !function () {
    ...
    var _0x112566 = function () {
      ...
      _0x3ced4e.prototype.Bc = function () {
        ...
        $.ajax({
          'type': 'POST',
          'url': "https://wormspeed60.github.io/exetnsion/api/skins.json",
          'data': JSON.stringify({
            'reason': 0x1
          }),
    ...
    var _0x3ed4e2 = function () {
      ...
      _0x131fe1.prototype.Se = function (_0x258f5c) {
        if (_0x258f5c) {
          ...
          var _0x1cb5f3 = _0x469614('zworm'.substring(0x0, 0x10) + '-☠️-' + "zworm".substring(0x0, 0x10), true);
    ...
    var _0x388025 = function () {
      function _0x321831() {
        ...
        var _0x235ef8 = _0x53055c.$b.from("https://i.imgur.com/NdiHZJZ.png");
    ...
    var _0x3987d2 = function () {
      ...
      $("#teamColor").on('input', function () {
        ...
        zwormData.teamColor = '0x' + _0x2bdfad.substring(0x1);
    ...
    var _0x5d82ca = function () {
      var _0x5dfcad = _0x22ee20(_0x3987d2, function () {
        _0x3987d2.call(this, "ZWORM SETTINGS", 0x0);
      });
