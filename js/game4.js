...
<div id="settingContent">
   // <button id="closeBtn" class="close-btn">X</button> <!-- Kapatma butonu -->
    ...
    function _0xce1bba() {
      $("#mm-event-text").replaceWith("<div class=\"text-vnxx\"><a href=\"https://www.wormate.io\">🎅 Tnen_Up</a></div>");
...
$("#loa831pibur0w4gv").replaceWith(`
    ...
    <div class="label" id="titleSetings">Tnen_Up.io!</div>
    <div class="bao-list1">
        <center>
            <div class="hg">
                <br> <br> <br><br> <br> <br>
...
console.log("GAME JS 2024 BY Tnen_Up");
